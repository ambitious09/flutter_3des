...
import com.example.flutter_3des_plugin.encoder.BASE64Decoder;
...
public class DesUtil {
    ...
    public static String Encrypt(String content, String key) throws Exception {
        SecretKey k = get3DesKey(key);
        Cipher cipher = Cipher.getInstance("Desede/ECB/PKCS5Padding");
        cipher.init(Cipher.ENCRYPT_MODE, k);
        byte[] output = cipher.doFinal(content.getBytes());
        String enstr = Base64.encodeBase64String(output);
        return enstr;
    }
    ...
    public static  String decryptDESCBC(final String src, final String key) throws Exception {
        ...
        // String IV = "1234567-";
        String IV = ":8574857";//content.substring(21,29);
